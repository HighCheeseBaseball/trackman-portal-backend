...
let users = [
  { id: 1, username: "steve.smith", password: "password123", name: "Steve Smith", email: "steve@example.com" },
  { id: 2, username: "michael.brown", password: "password123", name: "Michael Brown", email: "michael@example.com" }
];
